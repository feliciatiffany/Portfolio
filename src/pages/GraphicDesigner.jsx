...
/* Thumb (same element scales via CSS) */
...
export default function GraphicDesigner() {
  const projects = byCategory("graphic");
  return (
    <>
      ...
      <section className="projects projects--tiny projects--block projects--side projects--grid graphicdesigner-page">
        {projects.map((row) => (
